...
const AlertDialogContent = ({
  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      className={cn(
        'bg-bg-default data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:supram-out-95 data-[state=open]:supram-in-95 border-divider fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border p-6 shadow-lg duration-200 sm:max-w-lg',
        className,
      )}
      ref={ref}
      {...props}
