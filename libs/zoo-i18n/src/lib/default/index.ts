export default {
  extension: {
    welcome:
      'Transform your web browsing experience using AI with Zoo Visor ✨',
  },
  homepage: {
  ...
  desktop: {
    welcome: 'Welcome to Zoo',
    welcomeDescription:
      '<b>Zoo lets you build AI agents in minutes — fast, private, and secure.</b> Run locally, collaborate through a decentralized network, and create AI workflows effortlessly. ',
    localAI: 'Zoo Local AI',
    benefits: {
      local:
        '<b>Local:</b> With a local Zoo, you gain complete control over your data in a secure environment.',
      privacy:
  ...
  chatDM: {
    ...
    form: {
      zooIdentity: 'Zoo Identity',
      message: 'Message',
      messagePlaceholder: 'Enter your message',
    },
  },
  quickAsk: {
    emptyStateTitle: 'Ask Zoo AI',
  ...
  chat: {
    ...
    emptyStateTitle: 'Ask Zoo AI',
    emptyStateDescription:
      'For quick questions, press ⌘ + Shift + J to use Zoo Spotlight',
  ...
  vectorFs: {
    ...
    actions: {
      ...
      uploadFileText:
        'Uploading your files transforms them to be AI-ready and available to use in Zoo.',
      shareFolderText:
    ...
    shareFolderWarning: {
      ...
      text: 'You must register a Zoo identity before you can share folders over the Zoo Network.',
  ...
  zooNode: {
    restartNode: 'Please restart your Zoo Node',
    nodeAddress: 'Node Address',
    nodeVersion: 'Node Version',
    unavailable: 'Your Zoo Node is unavailable',
    notifications: {
      startingNode: 'Starting your local Zoo Node',
      runningNode: 'Your local Zoo Node is running',
      stoppedNode: 'Your local Zoo Node was stopped',
      stopNode: 'Stopping your local Zoo Node',
      removedNote: 'Your local Zoo Node storage was removed',
      ...
      syncedOllama: 'Local Ollama models synchronized with your Zoo Node',
      errorSyncOllama:
        'Error synchronizing your local Ollama models with your Zoo Node',
    ...
    manager: 'Zoo Node Manager',
    resetNodeWarning: {
      title: 'Unable to connect',
      description:
        'Your Zoo Node is currently locked by existing keys. To connect again, you can reset all your Zoo Node data.',
      option1:
        '<b>Restore:</b> Try to restore your connection using a backed up keys.',
      option2:
        '<b>Reset Data:</b> Permanently delete all your Zoo Node data.',
      option3:
        '<b>Reset All:</b> Permanently delete all your Zoo Node data including the encryption and signing keys.',
    },
    models: {
      labels: {
        models: 'Models',
  ...
  onboardingChecklist: {
    getStartedText: 'Get Started with Zoo',
    getStartedChecklist: 'Get started checklist',
    setupZooDesktop: 'Setup Zoo Desktop',
    setupZooDesktopDescription: 'Setup Zoo Desktop to get started',
  ...
  settings: {
    ...
    zooIdentity: {
      label: 'Zoo Identity',
      updatedIdentity: 'Zoo Identity updated successfully.',
      registerIdentity: 'Register your Zoo Identity',
      troubleRegisterIdentity: 'Trouble registering your Identity?',
      saveWillRestartApp: 'Save will restart the App to apply changes',
      goToZooIdentity: 'Go to My Zoo Identity',
      success: 'Zoo Identity updated successfully',
      error: 'Error updating Zoo Identity',
      checkIdentityInSync: 'Verify Zoo Identity',
      checkIdentityInSyncDescription:
        'Check that your zoo identity are accurately in sync.',
    },
    general: 'General',
    sidebar: {
      label: 'Sidebar',
    ...
    quickAccessButton: {
      label: 'Show Zoo Quick Access Button',
      description:
    ...
    zooVersion: 'Zoo Desktop Version:',
    shortcutKey: {
      label: 'Shortcut Key',
    ...
    remoteAccess: {
      title: 'Remote Access',
      description:
        'Easily and securely connect to your Zoo node from anywhere using ngrok. No complex setup—just  <a>create a free ngrok account</a>, copy your <b>ngrok auth token</b> from the dashboard, and paste it below to enable secure remote access.',
      connected: 'Connected',
      ...
      success:
        'Connected! Your Zoo node is now accessible remotely via ngrok',
  ...
  exportConnection: {
    ...
    restoreText:
      'Use it with your passphrase to restore the connection to your Zoo Node',
    form: {
  ...
  common: {
    ...
    optIn: 'Opt In',
    optOut: 'Opt Out',
    logInZooHosting: 'Log In To Zoo Hosting',
    signUpZooHosting: 'Sign up For Zoo Hosting',
    quickConnect: 'Quick Connect',
    alreadyHaveNode: 'Already have a Node?',
    zooPrivate: 'Setup Your Local AI',
  ...
  quickConnection: {
    ...
    connectingToNode: 'Connecting to your local Zoo Node',
  },
  analytics: {
    label: 'Analytics',
    title: 'Help us improve Zoo',
    bulletPoints: {
  ...
  llmProviders: {
    ...
    notFound: {
      ...
      description:
        'Connect your first AI to start asking Zoo AI. Try connecting OpenAI',
    },
    localAI: {
  ...
  galxe: {
    ...
    success: {
      registerDesktopInstallation:
        'Your Zoo Desktop installation was registered successfully. It may take some hours to be registered in Galxe quest.',
    },
    errors: {
      registerDesktopInstallation:
        'Error registering your Zoo Desktop installation. Please ensure your EVM Address was not used previously to register a different installation.',
    },
  },
  mcpServers: {
    label: 'MCP Servers',
    ...
    addDescription:
      'Configure a new MCP server to connect with your Zoo Node',
    ...
    title: 'MCP Servers',
    listDescription: 'List of MCP servers connected to your Zoo Node',
    composio: {
  ...
  tools: {
    ...
    create: {
      ...
      zooCodeGenerator: 'Zoo Code Generator',
      zooCodeGeneratorDescription:
        'Builds tools using our specialized AI code-generation tool.',
      zooFreeTrial: 'Zoo Eco-1',
      zooFreeTrialDescription:
        'Great for building tools, works with any content you provide.',
      zooFreeTrialRecommendation:
    ...
    visitStore:
      'Visit the Zoo Store to discover and install additional tools to enhance your workflow',
  ...
  errors: {
    nodeUnavailable: {
      ...
      description:
        "We're having trouble connecting to your Zoo Node. Your node may be offline, or your internet connection may be down.",
    },
  },
  notifications: {
    messageReceived: {
  ...
  mcpClients: {
    ...
    customDescriptionSecondary:
      'If your client does not support SSE, you can run the Zoo MCP server as a separate process using this command:',
  ...
  feedback: {
    button: 'Feedback',
    description:
      'We value your feedback! Please let us know your thoughts about Zoo and how we can improve your experience.',
  ...
  networkAgentsPage: {
    ...
    addAgentFromIdDescription:
      'Add an agent to your collection using a Zoo ID. Example: @@official.sep-zoo/main/agent/youtube_expert',
    addAgentFromIdHelper: 'Enter the Zoo ID of the agent you want to add.',
    addAgentFromIdPlaceholder:
      'e.g. @@official.sep-zoo/main/agent/youtube_expert',
    ...
    registerZooIdentity: 'Register Zoo Identity',
    registerZooIdentityDescription:
      'Create your unique identity on the Zoo network to use and publish agents',
  ...
  mcpPage: {
    ...
    helpfulLinks:
      'You can find helpful MCPs to connect with Zoo at smithery.ai and composio.dev.',
  },
  errorBoundary: {
