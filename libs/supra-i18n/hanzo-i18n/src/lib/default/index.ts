export default {
  ...
  settings: {
    ...
    hanzoIdentity: {
      label: 'DID protocol',
      updatedIdentity: 'DID protocol updated successfully.',
      registerIdentity: 'Register your DID protocol',
      troubleRegisterIdentity: 'Trouble registering your Identity?',
      saveWillRestartApp: 'Save will restart the App to apply changes',
      goToHanzoIdentity: 'Go to My DID protocol',
      success: 'DID protocol updated successfully',
      error: 'Error updating DID protocol',
      checkIdentityInSync: 'Verify DID protocol',
  ...
  common: {
    ...
    optIn: 'Opt In',
    optOut: 'Opt Out',
    logInHanzoHosting: 'Log In To AI Hosting',
    signUpHanzoHosting: 'Sign up For AI Hosting',
  ...
  networkAgentsPage: {
    ...
    registerHanzoIdentity: 'Register DID protocol',
    registerHanzoIdentityDescription:
      'Create your unique identity on the AI Network to use and publish agents',
