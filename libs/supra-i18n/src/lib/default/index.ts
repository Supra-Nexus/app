export default {
  extension: {
    welcome:
      'Transform your web browsing experience using AI with Supra Visor ✨',
  },
  homepage: {
  ...
  desktop: {
    welcome: 'Welcome to Supra',
    welcomeDescription:
      '<b>Supra lets you build AI agents in minutes — fast, private, and secure.</b> Run locally, collaborate through a decentralized network, and create AI workflows effortlessly. ',
    localAI: 'Supra Local AI',
    benefits: {
      local:
        '<b>Local:</b> With a local Supra, you gain complete control over your data in a secure environment.',
      privacy:
  ...
  chat: {
    ...
    emptyStateTitle: 'Ask Supra AI',
    emptyStateDescription:
      'For quick questions, press ⌘ + Shift + J to use Supra Spotlight',
  ...
  vectorFs: {
    ...
    actions: {
      ...
      uploadFileText:
        'Uploading your files transforms them to be AI-ready and available to use in Supra.',
      shareFolderText:
    ...
    shareFolderWarning: {
      ...
      text: 'You must register a Supra identity before you can share folders over the Supra Network.',
  ...
  supraNode: {
    restartNode: 'Please restart your Supra Node',
    nodeAddress: 'Node Address',
    nodeVersion: 'Node Version',
    unavailable: 'Your Supra Node is unavailable',
    notifications: {
      startingNode: 'Starting your local Supra Node',
      runningNode: 'Your local Supra Node is running',
      stoppedNode: 'Your local Supra Node was stopped',
      stopNode: 'Stopping your local Supra Node',
      removedNote: 'Your local Supra Node storage was removed',
      ...
      syncedOllama: 'Local Ollama models synchronized with your Supra Node',
      errorSyncOllama:
        'Error synchronizing your local Ollama models with your Supra Node',
    ...
    manager: 'Supra Node Manager',
    resetNodeWarning: {
      title: 'Unable to connect',
      description:
        'Your Supra Node is currently locked by existing keys. To connect again, you can reset all your Supra Node data.',
      option1:
        '<b>Restore:</b> Try to restore your connection using a backed up keys.',
      option2:
        '<b>Reset Data:</b> Permanently delete all your Supra Node data.',
      option3:
        '<b>Reset All:</b> Permanently delete all your Supra Node data including the encryption and signing keys.',
    },
    models: {
      labels: {
        models: 'Models',
  ...
  onboardingChecklist: {
    getStartedText: 'Get Started with Supra',
    getStartedChecklist: 'Get started checklist',
    setupSupraDesktop: 'Setup Supra Desktop',
    setupSupraDesktopDescription: 'Setup Supra Desktop to get started',
  ...
  settings: {
    ...
    supraIdentity: {
      label: 'Supra Identity',
      updatedIdentity: 'Supra Identity updated successfully.',
      registerIdentity: 'Register your Supra Identity',
      troubleRegisterIdentity: 'Trouble registering your Identity?',
      saveWillRestartApp: 'Save will restart the App to apply changes',
      goToSupraIdentity: 'Go to My Supra Identity',
      success: 'Supra Identity updated successfully',
      error: 'Error updating Supra Identity',
      checkIdentityInSync: 'Verify Supra Identity',
      checkIdentityInSyncDescription:
        'Check that your supra identity are accurately in sync.',
    },
    general: 'General',
    sidebar: {
      label: 'Sidebar',
    ...
    quickAccessButton: {
      label: 'Show Supra Quick Access Button',
      description:
    ...
    supraVersion: 'Supra Desktop Version:',
    shortcutKey: {
      label: 'Shortcut Key',
    ...
    remoteAccess: {
      title: 'Remote Access',
      description:
        'Easily and securely connect to your Supra node from anywhere using ngrok. No complex setup—just  <a>create a free ngrok account</a>, copy your <b>ngrok auth token</b> from the dashboard, and paste it below to enable secure remote access.',
      connected: 'Connected',
      ...
      success:
        'Connected! Your Supra node is now accessible remotely via ngrok',
  ...
  exportConnection: {
    ...
    restoreText:
      'Use it with your passphrase to restore the connection to your Supra Node',
    form: {
  ...
  common: {
    ...
    optIn: 'Opt In',
    optOut: 'Opt Out',
    logInSupraHosting: 'Log In To Supra Hosting',
    signUpSupraHosting: 'Sign up For Supra Hosting',
    quickConnect: 'Quick Connect',
    alreadyHaveNode: 'Already have a Node?',
    supraPrivate: 'Setup Your Local AI',
  ...
  quickConnection: {
    ...
    connectingToNode: 'Connecting to your local Supra Node',
  },
  analytics: {
    label: 'Analytics',
    title: 'Help us improve Supra',
    bulletPoints: {
  ...
  mcpServers: {
    ...
    addDescription:
      'Configure a new MCP server to connect with your Supra Node',
    ...
    title: 'MCP Servers',
    listDescription: 'List of MCP servers connected to your Supra Node',
    composio: {
  ...
  tools: {
    ...
    create: {
      ...
      supraCodeGenerator: 'Supra Code Generator',
      supraCodeGeneratorDescription:
        'Builds tools using our specialized AI code-generation tool.',
      supraFreeTrial: 'Supra Eco-1',
      supraFreeTrialDescription:
        'Great for building tools, works with any content you provide.',
      supraFreeTrialRecommendation:
    ...
    visitStore:
      'Visit the Supra Store to discover and install additional tools to enhance your workflow',
  ...
  errors: {
    nodeUnavailable: {
      ...
      description:
        "We're having trouble connecting to your Supra Node. Your node may be offline, or your internet connection may be down.",
    },
  },
  notifications: {
    messageReceived: {
  ...
  mcpClients: {
    ...
    customDescriptionSecondary:
      'If your client does not support SSE, you can run the Supra MCP server as a separate process using this command:',
  ...
  feedback: {
    button: 'Feedback',
    description:
      'We value your feedback! Please let us know your thoughts about Supra and how we can improve your experience.',
  ...
  networkAgentsPage: {
    ...
    addAgentFromIdDescription:
      'Add an agent to your collection using a Supra ID. Example: @@official.sep-supra/main/agent/youtube_expert',
    addAgentFromIdHelper: 'Enter the Supra ID of the agent you want to add.',
    addAgentFromIdPlaceholder:
      'e.g. @@official.sep-supra/main/agent/youtube_expert',
    ...
    registerSupraIdentity: 'Register Supra Identity',
    registerSupraIdentityDescription:
      'Create your unique identity on the Supra network to use and publish agents',
  ...
  mcpPage: {
    ...
    helpfulLinks:
      'You can find helpful MCPs to connect with Supra at smithery.ai and composio.dev.',
  },
  errorBoundary: {
