...
export type GetToolsResponse = SupraToolHeader[];
export type GetToolsSearchResponse = [SupraToolHeader, number][];
...
export type GetSupraFileProtocolRequest = { file: string };
export type GetSupraFileProtocolResponse = Blob;
...
export type GetInstalledNetworkToolsResponse = SupraToolHeader[];

export type AddNetworkToolRequest = {
  assets: any[];
  tool: {
    type: 'Network';
    content: [NetworkSupraTool, boolean];
  };
};
