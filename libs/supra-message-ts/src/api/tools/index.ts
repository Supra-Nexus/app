...
import {
  ...
  type GetSupraFileProtocolRequest,
  type GetSupraFileProtocolResponse,
...
export const createTool = async (
  ...
  const response = await httpClient.post(
    urlJoin(nodeAddress, '/v2/add_supra_tool'),
    payload,
    {
...
export const getTool = async (
  ...
  const response = await httpClient.get(
    urlJoin(nodeAddress, '/v2/get_supra_tool'),
    {
      headers: { Authorization: `Bearer ${bearerToken}` },
...
export const getTools = async (
  ...
  const response = await httpClient.get(
    urlJoin(nodeAddress, '/v2/list_all_supra_tools'),
    {
      headers: { Authorization: `Bearer ${bearerToken}` },
...
export const searchTools = async (
  ...
  const response = await httpClient.get(
    urlJoin(nodeAddress, '/v2/search_supra_tool'),
    {
      headers: { Authorization: `Bearer ${bearerToken}` },
      params: { query },
      responseType: 'json',
...
export const updateTool = async (
  ...
  const response = await httpClient.post(
    urlJoin(nodeAddress, '/v2/set_supra_tool'),
    payload,
    {
      headers: { Authorization: `Bearer ${bearerToken}` },
...
export const getToolPlaygroundMetadata = async (
  ...
  const url = urlJoin(nodeAddress, '/v2/get_supra_tool_metadata');
  ...
  const response = await httpClient.post(
    ...
    payload,
    {
      headers: {
        ...
        'x-supra-app-id': xSupraAppId,
        'x-supra-tool-id': xSupraToolId,
      },
      responseType: 'json',
    },
  );
    ...
    payload,
    {
      headers: {
        ...
        ...(xSupraOriginalToolRouterKey && {
          'x-supra-original-tool-router-key': xSupraOriginalToolRouterKey,
        }),
      },
      responseType: 'json',
    },
  ...
  const response = await httpClient.post(
    ...
    payload,
    {
      headers: {
        ...
        'x-supra-app-id': xSupraAppId,
        'x-supra-tool-id': xSupraToolId,
        'x-supra-llm-provider': xSupraLLMProvider,
      },
      responseType: 'json',
    },
  );
...
export const getSupraFileProtocol = async (
  nodeAddress: string,
  bearerToken: string,
  payload: GetSupraFileProtocolRequest,
) => {
  const response = await httpClient.get(
    urlJoin(nodeAddress, '/v2/resolve_supra_file_protocol'),
    {
      headers: { Authorization: `Bearer ${bearerToken}` },
  ...
  return response.data as GetSupraFileProtocolResponse;
};
...
export const getToolProtocols = async () => {
  const response = await httpClient.get(
    'https://api.supra.com/kb/index.json',
    {
      responseType: 'json',
    },
  );
...
export const getInstalledNetworkTools = async (
  ...
  const response = await httpClient.get(
    urlJoin(nodeAddress, '/v2/list_all_network_supra_tools'),
    {
      headers: { Authorization: `Bearer ${bearerToken}` },
      responseType: 'json',
    },
...
export const getNetworkAgents = async () => {
  const response = await httpClient.get(
    'https://api.supra.com/store/dapps/offerings',
    { responseType: 'json' },
  );
