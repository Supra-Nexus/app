import { initialRegistration as initialRegistrationApi } from '@supraai/supra-message-ts/api/general/index';
import { type InitialRegistrationResponse } from '@supraai/supra-message-ts/api/general/types';
