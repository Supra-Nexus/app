...
export type GetToolsResponse = ZooToolHeader[];
export type GetToolsSearchResponse = [ZooToolHeader, number][];
...
export type GetZooFileProtocolRequest = { file: string };
export type GetZooFileProtocolResponse = Blob;
...
export type GetInstalledNetworkToolsResponse = ZooToolHeader[];

export type AddNetworkToolRequest = {
  assets: any[];
  tool: {
    type: 'Network';
    content: [NetworkZooTool, boolean];
  };
};
