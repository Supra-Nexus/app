...
import {
  ...
  type GetZooFileProtocolRequest,
  type GetZooFileProtocolResponse,
...
export const createTool = async (
  ...
  const response = await httpClient.post(
    urlJoin(nodeAddress, '/v2/add_zoo_tool'),
    payload,
    {
...
export const getTool = async (
  ...
  const response = await httpClient.get(
    urlJoin(nodeAddress, '/v2/get_zoo_tool'),
    {
      headers: { Authorization: `Bearer ${bearerToken}` },
...
export const getTools = async (
  ...
  const response = await httpClient.get(
    urlJoin(nodeAddress, '/v2/list_all_zoo_tools'),
    {
      headers: { Authorization: `Bearer ${bearerToken}` },
...
export const searchTools = async (
  ...
  const response = await httpClient.get(
    urlJoin(nodeAddress, '/v2/search_zoo_tool'),
    {
      headers: { Authorization: `Bearer ${bearerToken}` },
      params: { query },
      responseType: 'json',
...
export const updateTool = async (
  ...
  const response = await httpClient.post(
    urlJoin(nodeAddress, '/v2/set_zoo_tool'),
    payload,
    {
      headers: { Authorization: `Bearer ${bearerToken}` },
...
export const getToolPlaygroundMetadata = async (
  ...
  const url = urlJoin(nodeAddress, '/v2/get_zoo_tool_metadata');
  ...
  const response = await httpClient.post(
    ...
    payload,
    {
      headers: {
        ...
        'x-zoo-app-id': xZooAppId,
        'x-zoo-tool-id': xZooToolId,
      },
      responseType: 'json',
    },
  );
    ...
    payload,
    {
      headers: {
        ...
        ...(xZooOriginalToolRouterKey && {
          'x-zoo-original-tool-router-key': xZooOriginalToolRouterKey,
        }),
      },
      responseType: 'json',
    },
  ...
  const response = await httpClient.post(
    ...
    payload,
    {
      headers: {
        ...
        'x-zoo-app-id': xZooAppId,
        'x-zoo-tool-id': xZooToolId,
        'x-zoo-llm-provider': xZooLLMProvider,
      },
      responseType: 'json',
    },
  );
...
export const getZooFileProtocol = async (
  nodeAddress: string,
  bearerToken: string,
  payload: GetZooFileProtocolRequest,
) => {
  const response = await httpClient.get(
    urlJoin(nodeAddress, '/v2/resolve_zoo_file_protocol'),
    {
      headers: { Authorization: `Bearer ${bearerToken}` },
  ...
  return response.data as GetZooFileProtocolResponse;
};
...
export const getToolProtocols = async () => {
  const response = await httpClient.get(
    'https://api.zoo.com/kb/index.json',
    {
      responseType: 'json',
    },
  );
...
export const getInstalledNetworkTools = async (
  ...
  const response = await httpClient.get(
    urlJoin(nodeAddress, '/v2/list_all_network_zoo_tools'),
    {
      headers: { Authorization: `Bearer ${bearerToken}` },
      responseType: 'json',
    },
...
export const getNetworkAgents = async () => {
  const response = await httpClient.get(
    'https://api.zoo.com/store/dapps/offerings',
    { responseType: 'json' },
  );
