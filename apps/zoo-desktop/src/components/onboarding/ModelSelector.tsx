...
import { PREINSTALLED_MODELS, OllamaModel } from '../../lib/zoo-node-manager/ollama-models';
...
export const ModelSelector: React.FC<ModelSelectorProps> = ({ onModelSelect, onSkip }) => {
  ...
  const getProviderIcon = (provider?: string) => {
    switch (provider) {
      case ModelProvider['Zoo-Backend']:
        return '🦁';
      ...
      <div className="model-selection">
        ...
        <div className="onboarding-actions">
          ...
          <div className="help-text">
            <p>💡 <strong>Tip:</strong> Start with Zoo Nano-1 if you're unsure. It's incredibly fast and works on any device!</p>
          </div>
        </div>
      </div>
