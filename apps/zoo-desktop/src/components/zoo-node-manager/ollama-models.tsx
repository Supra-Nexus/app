...
import { OLLAMA_MODELS } from '../../lib/zoo-node-manager/ollama-models';
import {
...
export const OllamaModels = ({
  ...
  const { data: isZooNodeRunning } = useZooNodeIsRunningQuery();
    ...
    return (
      <div className="flex h-full w-full flex-row items-center justify-center">
        <div className="text-text-secondary">
          ...
          Zoo Node to manage your AI models
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      ...
                      <Badge variant="outline" className="border-zinc-800 bg-zinc-900 text-zinc-400">
                        ...
                        <span className="ml-2 overflow-hidden text-ellipsis">
                          {t('zooNode.models.labels.bookPages', {
                            pages: Math.round(
      ...
      <span className="text-text-secondary w-full text-right text-xs">
        {t('zooNode.models.poweredByOllama')}
      </span>
        ...
        >
          ...
          >
            ...
            <span className="capitalize">
              {showAllOllamaModels
                ? t('zooNode.models.labels.showRecommended')
                : t('zooNode.models.labels.showAll')}
            </span>
          </Button>
          {rightBottomElement}
        </div>
