...
import OLLAMA_MODELS_REPOSITORY from '../../../lib/zoo-node-manager/ollama-models-repository.json';
...
const nonOllamaProviderModels = {
  'zoo-backend:free_text_inference':
    'Zoo AI model for text generation.',
  'zoo-backend:code_generator':
    'Zoo AI model for generating tool code.',
  'openai:gpt-4o':
              ...
              heading={
                <div className="flex items-center justify-between gap-2 pb-2">
                  ...
                  <Link
                    ...
                    to={
                      isLocalZooNodeIsUse ? '/install-ai-models' : '/add-ai'
                    }
                  >
                    <PlusIcon className="size-4" />
                    {t('common.add')}
