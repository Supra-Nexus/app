...
import { useStopGeneratingLLM } from '@zooai/zoo-node-state/v2/mutations/stopGeneratingLLM/useStopGeneratingLLM';
...
import { useGetNodeStorageLocation } from '@zooai/zoo-node-state/v2/queries/getNodeStorageLocation/useGetNodeStorageLocation';
...
import { formatText, getFileExt } from '@zooai/zoo-ui/helpers';
                      ...
                      {!selectedTool &&
                        ...
                        nodeStorageLocation && (
                          <OpenChatFolderActionBar
                            onClick={async () => {
                              try {
                                await invoke('zoo_node_open_chat_folder', {
