...
type SetJobScopeStore = {
  ...
  selectedFileKeysRef: Map<string, ZooPath>;
  selectedFolderKeysRef: Map<string, ZooPath>;
...
const createVectorFsStore = () =>
  createStore<SetJobScopeStore>((set) => ({
    ...
    selectedFileKeysRef: new Map<string, ZooPath>(),
    selectedFolderKeysRef: new Map<string, ZooPath>(),
