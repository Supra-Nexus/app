...
import { useGetPlaygroundTools } from '@zooai/zoo-node-state/v2/queries/getPlaygroundTools/useGetPlaygroundTools';
import { useGetTool } from '@zooai/zoo-node-state/v2/queries/getTool/useGetTool';
import { Skeleton } from '@zooai/zoo-ui';
...
export function isDenoZooTool(tool: ZooTool): tool is DenoZooTool {
  return (tool as DenoZooTool).js_code !== undefined;
}

export function isPythonZooTool(
  tool: ZooTool,
): tool is PythonZooTool {
  return (tool as PythonZooTool).py_code !== undefined;
}
