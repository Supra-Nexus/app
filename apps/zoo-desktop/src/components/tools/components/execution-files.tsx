import { useGetZooFilesProtocol } from '@zooai/zoo-node-state/v2/queries/getZooFileProtocol/useGetZooFilesProtocol';
import { FileList } from '@zooai/zoo-ui';
...
export function ExecutionFiles({ files, className }: ExecutionFilesProps) {
  ...
  const { data } = useGetZooFilesProtocol(
    {
