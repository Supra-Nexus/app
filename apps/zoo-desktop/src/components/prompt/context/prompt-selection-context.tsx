...
import { type Prompt } from '@zooai/zoo-message-ts/api/tools/types';
import { useCreatePrompt } from '@zooai/zoo-node-state/v2/mutations/createPrompt/useCreatePrompt';
import { useRemovePrompt } from '@zooai/zoo-node-state/v2/mutations/removePrompt/useRemovePrompt';
import { useUpdatePrompt } from '@zooai/zoo-node-state/v2/mutations/updatePrompt/useUpdatePrompt';
// import { useUpdatePrompt } from '@zooai/zoo-node-state/v2/mutations/updatePrompt/useUpdatePrompt';
import { useGetPromptList } from '@zooai/zoo-node-state/v2/queries/getPromptList/useGetPromptList';
import { useGetPromptSearch } from '@zooai/zoo-node-state/v2/queries/getPromptSearch/useGetPromptSearch';
import {
  Button,
  Dialog,
  DialogContent,
