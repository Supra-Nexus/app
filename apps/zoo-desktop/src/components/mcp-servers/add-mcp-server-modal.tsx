...
import {
  type McpServer,
  McpServerType,
} from '@zooai/zoo-message-ts/api/mcp-servers/types';
import { type AddMcpServerInput } from '@zooai/zoo-node-state/v2/mutations/addMcpServer/types';
import { useAddMcpServer } from '@zooai/zoo-node-state/v2/mutations/addMcpServer/useAddMcpServer';
import { type ImportMCPServerFromGithubURLOutput } from '@zooai/zoo-node-state/v2/mutations/importMCPServerFromGithubURL/types';
import { type UpdateMcpServerInput } from '@zooai/zoo-node-state/v2/mutations/updateMcpServer/types';
import { useUpdateMcpServer } from '@zooai/zoo-node-state/v2/mutations/updateMcpServer/useUpdateMcpServer';
import {
  Button,
  Dialog,
  DialogContent,
