...
export default function OnboardingStepper() {
  ...
  return (
    <Stepper
      steps={[
        {
          label: GetStartedSteps.SetupZooNode,
          status:
            currentStepsMap.get(GetStartedSteps.SetupZooNode) ??
            GetStartedStatus.NotStarted,
          title: t('onboardingChecklist.setupZooDesktop'),
          body: t('onboardingChecklist.setupZooDesktopDescription'),
        },
        {
