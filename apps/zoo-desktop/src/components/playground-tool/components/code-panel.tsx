// import { ToolMetadata } from '@zooai/zoo-message-ts/api/tools/types';
import { Button, Skeleton } from '@zooai/zoo-ui';
import { debounce } from '@zooai/zoo-ui/helpers';
    ...
    if (
      ...
      return (
        <p className="text-text-secondary pt-6 text-center text-xs">
          ...
          Ask Zoo AI to generate your tool code.
        </p>
      );
    }
