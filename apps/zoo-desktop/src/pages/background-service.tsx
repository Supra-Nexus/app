    ...
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          {t('Configure Zoo Node to run in the background')}
        </p>
      </div>
      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t('Automatically start Zoo Node when you log in to your computer')}
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Alert>
          ...
          <AlertDescription>
            {t(
              'When enabled, Zoo Node will start minimized in your system tray and be ready whenever you need it.'
            )}
          </AlertDescription>
        </Alert>
