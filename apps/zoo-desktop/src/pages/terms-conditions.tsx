...
} from '@zooai/zoo-node-state/forms/auth/quick-connection';
...
import { Button, buttonVariants, Checkbox } from '@zooai/zoo-ui';
...
const TermsAndConditionsPage = () => {
  ...
  }, [completeStep, isLocalZooNodeInUse, termsAndConditionsAcceptedLegacy]);
  ...
  const { isPending: zooNodeRemoveStorageIsPending } =
    useZooNodeRemoveStorageMutation();
  const {
  ...
  const { isPending: zooNodeKillIsPending } = useZooNodeKillMutation();
              ...
              components={{
                a: (
                  <a
                    ...
                    href={'https://www.zoo.ai/terms-of-service'}
                    rel="noreferrer"
                    target={'_blank'}
                  />
                ),
                b: (
                  <a
                    className={'text-text-default underline'}
                    href={'https://www.zoo.ai/privacy-policy'}
                    rel="noreferrer"
                    target={'_blank'}
                  />
                ),
