...
import { t, useTranslation } from '@zooai/zoo-i18n';
import {
...
} from '@zooai/zoo-node-state/forms/chat/inbox';
import { useRemoveJob } from '@zooai/zoo-node-state/v2/mutations/removeJob/useRemoveJob';
import { useUpdateInboxName } from '@zooai/zoo-node-state/v2/mutations/updateInboxName/useUpdateInboxName';
...
import { formatDateToLocaleStringWithTime } from '@zooai/zoo-ui/helpers';
            ...
            page.inboxes.map((inbox) => (
              <InboxMessageButton
                ...
                isJobLastMessage={
                  inbox.last_message
                    ? !(
                        inbox.last_message.sender === auth?.zoo_identity &&
