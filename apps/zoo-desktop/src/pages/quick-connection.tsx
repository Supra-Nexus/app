...
const QuickConnectionPage = () => {
  ...
  useEffect(() => {
    if (isNodeInfoSuccess && isZooPrivate && nodeInfo?.is_pristine) {
      toast.loading(t('quickConnection.connectingToNode'), {
        id: 'auto-connect-zoo-private',
      });
      void setupDataForm.handleSubmit(onSubmit)();
    }
  }, [isNodeInfoSuccess, isZooPrivate, nodeInfo, setupDataForm]);
