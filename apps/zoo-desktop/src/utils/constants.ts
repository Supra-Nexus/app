...
export const MODELS_WITH_THINKING_SUPPORT = {
  ...
  // Zoo Backend
  'zoo-backend:free_text_inference': { forceEnabled: true, reasoningLevel: true },
  'zoo-backend:standard_text_inference': { forceEnabled: true, reasoningLevel: true },
} as const;
