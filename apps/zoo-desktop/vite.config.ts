...
export default defineConfig(() => ({
  ...
  build: {
    rollupOptions: {
      input: {
        ...
        zoo_node_manager: resolve(
          __dirname,
          'src/windows/zoo-node-manager/index.html',
        ),
        ...
        zoo_artifacts: resolve(
          __dirname,
          'src/windows/zoo-artifacts/index.html',
        ),
      },
    },
  },
  test: {
    ...
    globals: true,
    cache: { dir: '../../node_modules/.vitest/apps/zoo-desktop' },
    environment: 'jsdom',
    include: ['src/**/*.{test,spec}.{js,mjs,cjs,ts,mts,cts,jsx,tsx}'],
    reporters: ['default'],
    coverage: {
      reportsDirectory: '../../coverage/libs/zoo-message-ts',
      provider: 'v8',
    },
  },
  worker: {
