...
const svgTemplate = `<svg width="1024" height="1024" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
  <!-- Supra Logo: Template Version for macOS Menu Bar -->
...
fs.writeFileSync('supra-template-icon.svg', svgTemplate);
...
const outlineTemplate = `<svg width="1024" height="1024" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
  <!-- Supra Logo: Outline Template for macOS Menu Bar -->
...
fs.writeFileSync('supra-template-outline.svg', outlineTemplate);
...
const hybridTemplate = `<svg width="1024" height="1024" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
  <!-- Supra Logo: Hybrid Template for macOS Menu Bar -->
...
fs.writeFileSync('supra-template-hybrid.svg', hybridTemplate);

console.log('Created three template variations:');
console.log('1. supra-template-icon.svg - Filled regions with opacity layers');
console.log('2. supra-template-outline.svg - Outlines with center dots');
console.log('3. supra-template-hybrid.svg - Combination of fills and outlines');
