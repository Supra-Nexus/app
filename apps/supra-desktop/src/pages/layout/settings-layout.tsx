...
import { openSupraNodeManagerWindow } from '../../lib/supra-node-manager/supra-node-manager-windows-utils';
...
export function MainNav() {
  ...
  const navigationLinks = [
    ...
    isLocalSupraNodeInUse && {
      title: t('settings.layout.supraNode'),
      href: '#',
      onClick: () => {
        void openSupraNodeManagerWindow();
      },
