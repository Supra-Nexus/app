...
import { useImportAgentFromUrl } from '@supraai/supra-node-state/v2/mutations/importAgentFromUrl/useImportAgentFromUrl';
import { useImportTool } from '@supraai/supra-node-state/v2/mutations/importTool/useImportTool';
...
const MainLayout = () => {
  ...
  useEffect(() => {
    ...
    void getCurrentWindow().emit('supra-app-ready');
    return () => {
