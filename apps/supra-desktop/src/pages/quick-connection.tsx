...
const QuickConnectionPage = () => {
  ...
  useEffect(() => {
    if (isNodeInfoSuccess && isSupraPrivate && nodeInfo?.is_pristine) {
      toast.loading(t('quickConnection.connectingToNode'), {
        id: 'auto-connect-supra-private',
      });
      void setupDataForm.handleSubmit(onSubmit)();
    }
  }, [isNodeInfoSuccess, isSupraPrivate, nodeInfo, setupDataForm]);
