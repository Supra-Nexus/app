...
import { type LLMProviderInterface } from '@supraai/supra-message-ts/api/jobs/types';
import {
  addAiModelFormDefault,
  type AddAiModelFormSchema,
  addAiModelSchema,
} from '@supraai/supra-node-state/forms/agents/add-ai';
import {
  Models,
  modelsConfig,
} from '@supraai/supra-node-state/lib/utils/models';
import { useAddLLMProvider } from '@supraai/supra-node-state/v2/mutations/addLLMProvider/useAddLLMProvider';
import { useScanOllamaModels } from '@supraai/supra-node-state/v2/queries/scanOllamaModels/useScanOllamaModels';
import {
  Button,
  buttonVariants,
  Form,
...
const getGuideUrl = (model: Models) => {
  if (!model) {
    return 'https://docs.supra.ngo/advanced/models';
  }

  const urlMap = {
    [Models.OpenAI]: 'https://docs.supra.ngo/advanced/models/gpt',
    [Models.TogetherComputer]:
      'https://docs.supra.ngo/advanced/models/together-ai',
    [Models.Ollama]: 'https://docs.supra.ngo/advanced/models/ollama',
    [Models.Gemini]: 'https://docs.supra.ngo/advanced/models/gemini',
    [Models.Groq]: 'https://docs.supra.ngo/advanced/models/groq',
    [Models.OpenRouter]: 'https://docs.supra.ngo/advanced/models/openrouter',
    [Models.Exo]: 'https://docs.supra.ngo/advanced/models/exo',
    [Models.Claude]: 'https://docs.supra.ngo/advanced/models/claude',
    [Models.DeepSeek]: 'https://docs.supra.ngo/advanced/models/deepseek',
    [Models.Grok]: 'https://docs.supra.ngo/advanced/models/grok',
  };

  return urlMap[model] || 'https://docs.supra.ngo/advanced/models';
};
  ...
  const onSubmit = async (data: AddAiModelFormSchema) => {
    ...
    await addLLMProvider({
      ...
      agent: {
        ...
        full_identity_name: `${auth.supra_identity}/${auth.profile}/agent/${generatedId}`,
        id: generatedId,
        model,
        name: data.name,
      },
