...
import { QuestNames } from '@supraai/supra-message-ts/api/quests/types';
import { useUpdateQuestsStatus } from '@supraai/supra-node-state/v2/mutations/updateQuestsStatus/useUpdateQuestsStatus';
import { useGetQuestsStatus } from '@supraai/supra-node-state/v2/queries/getQuestsStatus/useGetQuestsStatus';
import {
  Alert,
  AlertDescription,
  AlertTitle,
...
> = {
  [QuestNames.InstalledApp]: {
    name: 'Try Supra Desktop',
    description: 'Download and Install Supra Desktop.',
  },
  [QuestNames.CreateIdentity]: {
    name: 'Create Your Supra Identity',
    description:
      'Create an on-chain Supra Identity! This is require to participate in the decentralized peer to peer network.',
  },
  [QuestNames.DownloadFromStore]: {
    name: 'Download Your First Tool',
    description: 'Download your first tool from the Supra AI store.',
  },
  [QuestNames.ComeBack2Days]: {
    name: 'Return to Supra in 2 different days',
    description:
      'Return to Supra in 2 different days. Remember to create new chats each day!',
  },
  [QuestNames.ComeBack4Days]: {
    name: 'Return to Supra in 4 different days',
    description:
      'Return to Supra in 4 different days. Remember to create new chats each day!',
  },
  [QuestNames.ComeBack7Days]: {
    name: 'Return to Supra in 7 different days',
    description:
      'Return to Supra in 7 different days. Remember to create new chats each day!',
  },
  [QuestNames.CreateTool]: {
    name: 'Create Your First Tool',
    description:
      'Create and publish your first tool on Supra. Share your creativity with the community.',
  },
  [QuestNames.SubmitAndGetApprovalForTool]: {
    name: 'Submit and Get Approval for 1 Tool',
    description:
      'Submit your tool for review and get it approved by the Supra team.',
  },
  ...
  [QuestNames.FeaturedInRanking]: {
    ...
    description: 'Get featured in the Supra AI Store',
  },
  [QuestNames.WriteHonestReview]: {
    name: 'Write a Review',
    description:
      'Go to Supra Store and write a detailed and honest review about your experience with a Supra tool.',
  },
  [QuestNames.Write5HonestReview]: {
    name: 'Write 5 Reviews',
    description:
      'Go to Supra Store and write 5 detailed and honest reviews about your experience with Supra tools.',
  },
  [QuestNames.Write10HonestReview]: {
    name: 'Write 10 Reviews',
    description:
      'Go to Supra Store and write 10 detailed and honest reviews about your experience with Supra tools.',
  },
