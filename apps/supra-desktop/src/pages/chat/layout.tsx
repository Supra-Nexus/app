...
import { t, useTranslation } from '@supraai/supra-i18n';
import {
...
} from '@supraai/supra-node-state/forms/chat/inbox';
import { useRemoveJob } from '@supraai/supra-node-state/v2/mutations/removeJob/useRemoveJob';
import { useUpdateInboxName } from '@supraai/supra-node-state/v2/mutations/updateInboxName/useUpdateInboxName';
...
import { useGetInboxesWithPagination } from '@supraai/supra-node-state/v2/queries/getInboxes/useGetInboxesWithPagination';
import {
  Button,
  buttonVariants,
  Dialog,
...
import { formatDateToLocaleStringWithTime } from '@supraai/supra-ui/helpers';
            ...
            page.inboxes.map((inbox) => (
              <InboxMessageButton
                ...
                isJobLastMessage={
                  inbox.last_message
                    ? !(
                        inbox.last_message.sender === auth?.supra_identity &&
