...
// import { QRSetupData } from '@supraai/supra-message-ts/api/general/types';
// import { useSubmitRegistration } from '@supraai/supra-node-state/v2/mutations/submitRegistation/useSubmitRegistration';
// import { generateMyEncryptionKeys } from '@supraai/supra-node-state/v2/queries/getEncryptionKeys/index';
...
//   supra_identity: z.string().min(11),
...
//                         </p>
//                         <p className="text-text-secondary text-xs">JPG | PNG</p>
//                       </div>
//                       <input
