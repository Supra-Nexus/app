...
import { type Prompt } from '@supraai/supra-message-ts/api/tools/types';
import { buildInboxIdFromJobId } from '@supraai/supra-message-ts/utils/inbox_name_handler';
import { useCreateJob } from '@supraai/supra-node-state/v2/mutations/createJob/useCreateJob';
import { useRemovePrompt } from '@supraai/supra-node-state/v2/mutations/removePrompt/useRemovePrompt';
import { useUpdatePrompt } from '@supraai/supra-node-state/v2/mutations/updatePrompt/useUpdatePrompt';

import { useGetPromptList } from '@supraai/supra-node-state/v2/queries/getPromptList/useGetPromptList';
import { useGetPromptSearch } from '@supraai/supra-node-state/v2/queries/getPromptSearch/useGetPromptSearch';
import {
  Button,
  CopyToClipboardIcon,
  MarkdownText,
