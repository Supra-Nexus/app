...
import {
  ...
  editAIModelSchema,
} from '@supraai/supra-node-state/forms/agents/edit-ai';
import { Models } from '@supraai/supra-node-state/lib/utils/models';
import { useRemoveLLMProvider } from '@supraai/supra-node-state/v2/mutations/removeLLMProvider/useRemoveLLMProvider';
import { useUpdateLLMProvider } from '@supraai/supra-node-state/v2/mutations/updateLLMProvider/useUpdateLLMProvider';
...
import { CreateAIIcon } from '@supraai/supra-ui/assets';
...
import { useOllamaRemoveMutation } from '../lib/supra-node-manager/ollama-client';
  ...
  const submit = async (values: EditAIModelFormSchema) => {
    ...
    await updateLLMProvider({
      ...
      agent: {
        ...
        full_identity_name: `${auth.supra_identity}/${auth.profile}/agent/${llmProviderId}`,
        id: llmProviderId,
        model,
        name: values.name,
