...
import { useSetToolMcpEnabled } from '@supraai/supra-node-state/v2/mutations/setToolMcpEnabled/useSetToolMcpEnabled';
              ...
              <TabsList className="flex h-10 w-fit items-center gap-2 rounded-full bg-transparent px-1 py-1">
                ...
                >
                  ...
                  <span className="text-text-secondary inline-flex items-center gap-1 text-xs">
                    MCP <MoveRightIcon className="size-2.5" /> Supra
                  </span>
                </TabsTrigger>
                <TabsTrigger
                  className={cn(
                ...
                >
                  ...
                  <span className="text-text-secondary inline-flex items-center gap-1 text-xs">
                    Supra <MoveRightIcon className="size-2.5" /> MCP
                  </span>
                </TabsTrigger>
              </TabsList>
            </div>
...
const ExposeToolsAsMcp = () => {
  ...
  const handleShowCustomInstructions = async () => {
    ...
    const nodeUrl = auth?.node_address || 'http://localhost:2000'; // Default or get from auth
