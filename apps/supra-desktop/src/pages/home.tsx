...
import { SUPRA_DOCS_URL, SUPRA_TUTORIALS } from '../utils/constants';
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto mt-[110px] flex w-full max-w-[1050px] flex-col items-stretch gap-6">
        ...
        {/* Supra AI Tutorial Video */}
        <div className="mx-auto w-full max-w-md">
          <VideoBanner
            title="Getting Started with Supra AI"
            videoUrl={SUPRA_TUTORIALS['supra-tools']}
            duration="2:30"
          />
        </div>
