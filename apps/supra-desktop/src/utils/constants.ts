...
export const SUPRA_DOCS_URL = 'https://docs.supra.ngo';

export const SUPRA_TUTORIALS = {
  'add-ai':
...
export const MODELS_WITH_THINKING_SUPPORT = {
  ...
  // Supra Backend
  'supra-backend:free_text_inference': { forceEnabled: true, reasoningLevel: true },
  'supra-backend:standard_text_inference': { forceEnabled: true, reasoningLevel: true },
} as const;
