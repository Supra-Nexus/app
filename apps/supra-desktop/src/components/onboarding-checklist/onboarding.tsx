...
export default function OnboardingStepper() {
  ...
  return (
    <Stepper
      steps={[
        {
          label: GetStartedSteps.SetupSupraNode,
          status:
            currentStepsMap.get(GetStartedSteps.SetupSupraNode) ??
            GetStartedStatus.NotStarted,
          title: t('onboardingChecklist.setupSupraDesktop'),
          body: t('onboardingChecklist.setupSupraDesktopDescription'),
        },
        {
