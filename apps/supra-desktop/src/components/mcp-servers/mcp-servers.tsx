...
import { McpServerType } from '@supraai/supra-message-ts/api/mcp-servers/types';
...
import { useSetEnableMcpServer } from '@supraai/supra-node-state/v2/mutations/setEnableMcpServer/useSetEnableMcpServer';
import { useGetMcpServers } from '@supraai/supra-node-state/v2/queries/getMcpServers/useGetMcpServers';
import {
  Button,
  DropdownMenu,
  DropdownMenuContent,
