...
import {
  type McpServer,
  McpServerType,
} from '@supraai/supra-message-ts/api/mcp-servers/types';
import { type AddMcpServerInput } from '@supraai/supra-node-state/v2/mutations/addMcpServer/types';
import { useAddMcpServer } from '@supraai/supra-node-state/v2/mutations/addMcpServer/useAddMcpServer';
import { type ImportMCPServerFromGithubURLOutput } from '@supraai/supra-node-state/v2/mutations/importMCPServerFromGithubURL/types';
import { type UpdateMcpServerInput } from '@supraai/supra-node-state/v2/mutations/updateMcpServer/types';
import { useUpdateMcpServer } from '@supraai/supra-node-state/v2/mutations/updateMcpServer/useUpdateMcpServer';
import {
  Button,
  Dialog,
  DialogContent,
