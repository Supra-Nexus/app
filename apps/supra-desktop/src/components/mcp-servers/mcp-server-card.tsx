...
import { type McpServer } from '@supraai/supra-message-ts/api/mcp-servers/types';
import { useDeleteMcpServer } from '@supraai/supra-node-state/v2/mutations/deleteMcpServer/useDeleteMcpServer';
import { useGetMCPServerTools } from '@supraai/supra-node-state/v2/queries/getMCPServerTools/useGetMCPServerTool';
import {
  Badge,
  Button,
  buttonVariants,
