...
import { useSetToolOffering } from '@supraai/supra-node-state/v2/mutations/setToolOffering/useSetToolOffering';
            ...
            <div className="flex !max-h-[500px] flex-col gap-5 overflow-y-scroll">
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-2">
                  ...
                  >
                    I understand that Supra reserves the right to remove any
