...
import { type SupraPath } from '@supraai/supra-message-ts/api/jobs/types';
...
const SearchNodeFiles = () => {
  ...
  const selectedFileKeysRef = useRef<Map<string, SupraPath>>(new Map());
    ...
    <SimpleLayout>
      ...
      >
        ...
        >
          ...
          <p className="text-text-secondary mx-auto text-center text-sm">
