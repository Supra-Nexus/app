...
import { useCreateFolder } from '@supraai/supra-node-state/v2/mutations/createFolder/useCreateFolder';
import { useRemoveFsItem } from '@supraai/supra-node-state/v2/mutations/removeFsItem/useRemoveFsItem';
    ...
    <>
      ...
      <Form {...createTextFileForm}>
        ...
        >
          ...
          >
            <p className="text-text-secondary text-xs font-semibold">Content</p>
            <PrismErrorBoundary>
              <ToolCodeEditor
                language="txt"
