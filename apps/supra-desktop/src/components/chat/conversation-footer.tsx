...
} from '@supraai/supra-node-state/forms/chat/chat-message';
import { DEFAULT_CHAT_CONFIG } from '@supraai/supra-node-state/v2/constants';
import { useSendMessageToJob } from '@supraai/supra-node-state/v2/mutations/sendMessageToJob/useSendMessageToJob';
import { useStopGeneratingLLM } from '@supraai/supra-node-state/v2/mutations/stopGeneratingLLM/useStopGeneratingLLM';
import { useAgentsWithFallback } from '../../hooks/use-agents-with-fallback';
import { useGetChatConfig } from '@supraai/supra-node-state/v2/queries/getChatConfig/useGetChatConfig';
import { useGetJobFolderName } from '@supraai/supra-node-state/v2/queries/getJobFolderName/useGetJobFolderName';
import { useGetNodeStorageLocation } from '@supraai/supra-node-state/v2/queries/getNodeStorageLocation/useGetNodeStorageLocation';
import { useGetProviderFromJob } from '@supraai/supra-node-state/v2/queries/getProviderFromJob/useGetProviderFromJob';
...
import { formatText, getFileExt } from '@supraai/supra-ui/helpers';
                      ...
                      {!selectedTool &&
                        ...
                        nodeStorageLocation && (
                          <OpenChatFolderActionBar
                            onClick={async () => {
                              try {
                                await invoke('supra_node_open_chat_folder', {
