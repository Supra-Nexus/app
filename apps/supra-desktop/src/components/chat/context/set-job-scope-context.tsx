...
type SetJobScopeStore = {
  ...
  selectedFileKeysRef: Map<string, SupraPath>;
  selectedFolderKeysRef: Map<string, SupraPath>;
...
const createVectorFsStore = () =>
  createStore<SetJobScopeStore>((set) => ({
    ...
    selectedFileKeysRef: new Map<string, SupraPath>(),
    selectedFolderKeysRef: new Map<string, SupraPath>(),
