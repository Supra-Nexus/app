// import { ToolMetadata } from '@supraai/supra-message-ts/api/tools/types';
import { Button, Skeleton } from '@supraai/supra-ui';
import { debounce } from '@supraai/supra-ui/helpers';
    ...
    if (
      ...
      return (
        <p className="text-text-secondary pt-6 text-center text-xs">
          ...
          Ask Supra AI to generate your tool code.
        </p>
      );
    }
