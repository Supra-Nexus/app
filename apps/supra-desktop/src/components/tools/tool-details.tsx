import {
  type AgentSupraTool,
  type DenoSupraTool,
  type NetworkSupraTool,
  type PythonSupraTool,
  type RustSupraTool,
  type McpServerTool as McpServerToolType,
  type SupraTool,
} from '@supraai/supra-message-ts/api/tools/types';
import { useGetPlaygroundTools } from '@supraai/supra-node-state/v2/queries/getPlaygroundTools/useGetPlaygroundTools';
import { useGetTool } from '@supraai/supra-node-state/v2/queries/getTool/useGetTool';
import { Skeleton } from '@supraai/supra-ui';
...
export function isDenoSupraTool(tool: SupraTool): tool is DenoSupraTool {
  return (tool as DenoSupraTool).js_code !== undefined;
}

export function isPythonSupraTool(
  tool: SupraTool,
): tool is PythonSupraTool {
  return (tool as PythonSupraTool).py_code !== undefined;
}
