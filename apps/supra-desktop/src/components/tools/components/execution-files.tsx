import { useGetSupraFilesProtocol } from '@supraai/supra-node-state/v2/queries/getSupraFileProtocol/useGetSupraFilesProtocol';
import { FileList } from '@supraai/supra-ui';
...
export function ExecutionFiles({ files, className }: ExecutionFilesProps) {
  ...
  const { data } = useGetSupraFilesProtocol(
    {
